...
![fork](images/documentation/forkkk.png)
...
Μας πηγαίνει στο repository του γενικού εκεί προσέχουμε να έχουμε ως base repository του __@teo-tsirpanis__ και head το δικό μας. Πατάμε Pull request

![pull](images/documentation/pull.png)
