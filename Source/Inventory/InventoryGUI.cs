...
namespace DayGame
{
    public partial class InventoryGUI : Form
    {
        ...
        public Item spathi = new Weapon("Spathi", "spathi dou takesi", null, 15, 5);
        public Item panoplia = new Armor("Armor D", "Armor tou takesi", null, 3, 5);
        public Armor armor = new Armor("Armor D", "Armor tou takesi", null, 3, 5);
        public Spell spell = new Spell("SpellName", "This is a spell", null, 0, 15);
        public Potion potion = new Potion("PotionName", "This is a potion", null, 0, 15);
        ...
        private void Equip(object sender, EventArgs e)
        {
            ...
            //(epeidh an einai keno, dhladh xwris item, tote to item einai = me null, kai buggarei to programma)
            {
                ...
                if (Equip.ShowDialog(this) == DialogResult.OK)
                {
                    ...
                    else if (!inv.IsBagFull && (inv.ChestSpace[ButtonToChest[ChestButtonPressed]].GetType() == typeof(Spell)))
                    ...
                    else if (!inv.IsBagFull && (inv.ChestSpace[ButtonToChest[ChestButtonPressed]].GetType() == typeof(Potion)))
                    //ean to bag einai empty, kai to button pou pathses exei einai NonConsumableItem
                    {
